...
<body>
    ...
    <div class="dashboard-main-wrapper">
     ...
     ProfessorService ii =ProfessorService.getInstance();
     
     %>
        <!-- ============================================================== -->
          <% 
          Professor pr =null;
  Professor prof = (Professor)  request.getAttribute("prof");
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h3 class="mb-2"> INFO sur  <%=prof.getFirstname()%> <%=prof.getLaststname()%> </h3>
                ...
                <div class="row">
                  ...
                  >
                    <div
                      ...
                      style="padding-bottom: 132px; padding-top: 123px;"
                    >
                      <div class="border-bottom pb-3 mb-3">
                        <h2 class="mb-3"><%=prof.getFirstname()%> <%=prof.getLaststname()%></h2>
                        <div
