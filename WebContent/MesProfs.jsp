                ...
                <div class="container-fluid dashboard-content">
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h3 class="mb-2"> Les Pros De <%=temp.getFirstanme()%> <%=temp.getLastname()%> </h3>
                               
                                <div class="page-breadcrumb">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Menu</a></li>
                                            <li class="breadcrumb-item active" aria-current="page">Mes Profs</li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-9 col-lg-8 col-md-8 col-sm-12 col-12">
                            ...
                            <!-- ============================================================== -->
                           <%try{
								List<Professor> mypr = (List<Professor>) request.getAttribute("prof");
								if(mypr.equals(null))
									mypr=new ArrayList<Professor>();
								for (Professor c : mypr) { %>
                            <div class="card">
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-xl-9 col-lg-12 col-md-12 col-sm-12 col-12">
                                            <div class="user-avatar float-xl-left pr-4 float-none">
                                                <img src="https://i.ibb.co/gmCFmPY/Laptop-User.png" alt="User Avatar" class="rounded-circle user-avatar-xl">
                                                    </div>
                                                <div class="pl-xl-3">
                                                    <div class="m-b-0">
                                                        <div class="user-avatar-name d-inline-block">
                                                            <h2 class="font-24 m-b-10"><%=c.getFirstname()%> <%=c.getLaststname()%></h2>
                                                        </div>
                                                    ...
                                                    <div class="user-avatar-address">
                                                        ...
                                                        <p class="mb-2"><i class="fa fa-fw fa-address-card"></i><%=c.getDepartement()%></span>
                                                        </p>
                                            ...
                                            <div class="col-xl-3 col-lg-12 col-md-12 col-sm-12 col-12">
                                                <div class="float-xl-right float-none mt-xl-0 mt-4">
                                                    <form method="post" action="ProfInfo">
                                                        <input type="hidden" name="CIN" value=<%=c.getCin()%> />
                                                    <button  class="btn btn-primary" type="submit">toutes les TP</button>
                                                </form>
                                                </div>
                                            </div>
                                        </div>
